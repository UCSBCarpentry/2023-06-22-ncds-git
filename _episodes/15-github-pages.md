...
Let's continue from the GitHub repository we have created in the previous episode. One important file you should already have is `index.md`, which will become the homepage of your project website (until we add the index file later on).
